    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                var preSelected = <%= PreSelectedHerbsJS %>;
                preSelected.forEach(function (name) {
                    // Find by value attribute
                    // We need to be careful about quotes in values if any, but names are usually simple
                    var checkboxes = document.querySelectorAll('.herb-checkbox');
